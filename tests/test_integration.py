    ...
    def test_export_rule_data(self):
        ...
        self.assertEqual(
            all_data.get("variable_type_operators"),
            {
                ...
                'select_multiple': [
                    {'input_type': 'select_multiple', 'label': 'Compare State With Item (Only for Posting Rule Engine)', 'name': 'compare_state_with_item'},
                ...
                'string': [
                    ...
                    {'input_type': 'text', 'label': 'Does not contain (case insensitive)', 'name': 'does_not_contain_case_insensitive'},
